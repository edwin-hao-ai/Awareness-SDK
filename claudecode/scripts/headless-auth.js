 ...
 *   - sdks/claudecode/scripts/headless-auth.js         (this file)
 *   - sdks/openclaw/src/headless-auth.ts
 *
 * If you change one, sync the other three. See docs/features/f-035/.
 * Also: CLAUDE.md requires awareness-memory and claudecode scripts to
 * stay in lockstep — they serve different distribution channels but must
