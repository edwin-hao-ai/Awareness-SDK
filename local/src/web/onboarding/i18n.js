...
(function () {
  ...
  const EN = {
    ...
    'onb.welcome.telemetry_label': 'Send anonymous usage analytics (opt-in)',
    'onb.welcome.telemetry_hint': 'Helps us improve. We never collect memory content, file paths, queries, or IP addresses. Toggle anytime in Settings → Privacy.',
  ...
  const ZH = {
    ...
    'onb.welcome.telemetry_label': '匿名使用统计（需主动开启）',
    'onb.welcome.telemetry_hint': '帮助我们改进产品。我们绝不收集记忆内容、文件路径、查询内容或 IP 地址。可随时在 设置 → 隐私 中关闭。',
