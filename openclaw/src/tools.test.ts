...
describe("registerTools", () => {
  it("registers exactly 10 tools (8 awareness + 2 memory-core compatible)", () => {
    ...
    expect(ids).toContain("awareness_apply_skill");
    expect(ids).toContain("awareness_mark_skill_used");
