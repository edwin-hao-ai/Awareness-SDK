...
function registerTools(api, client) {
    ...
    api.registerTool({
        ...
        description: "DO NOT CALL — read this workflow reference.\n\n" +
    ...
    api.registerTool({
        id: "awareness_init",
        description: "Load cross-session project memory — NOT local code search. " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                recall_mode: {
                    ...
                    description: "Recall strategy: hybrid (DB + top vectors, default), auto, precise (chunks only), " +
    ...
    api.registerTool({
        ...
        execute: async (input) => {
            return client.getData(String(input.type ?? "context"), input);
        },
    });
    // -----------------------------------------------------------------------
    ...
    api.registerTool({
        id: "awareness_record",
        description: "Record events to cross-session persistent memory. See __awareness_workflow__ STEP 3.\n\n" +
        ...
        execute: async (input) => {
            return client.write(String(input.action ?? "remember"), input);
        },
    });
}
